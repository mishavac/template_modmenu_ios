...
self.layer.shadowRadius = 20;
    ...
    //title of the menu
    menuTitle = [[UILabel alloc]initWithFrame:CGRectMake(30, 2, menuWidth_ - 60, 50)];
    menuTitle.text = title_;
    menuTitle.textColor = titleColor_;
    menuTitle.font = [UIFont fontWithName:titleFont_ size:20.0f];
...
menuButton.layer.shadowOpacity = 6;
...
-(void)showPopup:(NSString *)title_ description:(NSString *)description_ {
    ...
    [alert addButton: @"❌" actionBlock: ^(void) {
