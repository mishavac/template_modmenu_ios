...
[switches addSliderSwitch:NSSENCRYPT("Width:")
               description:NSSENCRYPT("WireFrame Width")
                minimumValue:0
                  maximumValue:30
                    sliderColor:UIColorFromHex(0xFF0000)];

HOOK(0x1A0B498, aim, _aim);
HOOK(0x1AC0538, get_Gloves, old_get_Gloves);[switches addSwitch:@"WireFrame Red Chams"
description:@""];

[switches addSwitch:@"WireFrame Green Chams"
description:@""];

[switches addSwitch:@"WireFrame Blue Chams"
description:@""];
...
HOOK(0x1A0B498, aim, _aim);
HOOK(0x1AC0538, get_Gloves, old_get_Gloves);

[switches addSliderSwitch:NSSENCRYPT("Blue:")
               description:NSSENCRYPT("Blue Color")
                minimumValue:0
                  maximumValue:1
                    sliderColor:UIColorFromHex(0x7000E8)];

[switches addSwitch:@"WireFrame Red Chams"
description:@""];
...
[switches addOffsetSwitch:@"Team Radar"
              description:@"You Have To Look Towards Opponents"
                offsets:{0x1A4CAE8, 0x1c30d44}
                  bytes:{"0xC0035FD6","0x20008052C0035FD6"}];

[switches addOffsetSwitch:@"нет отдачи"
              description:@"Radar Hack"
                offsets:{0x18CFE0C}
                  bytes:{"0xC0035FD6"}];

[switches addOffsetSwitch:@"ндохуя бобла"
              description:@"Radar Hack"
                offsets:{0x1C64824}
                  bytes:{"0x00008052C0035FD6"}];
