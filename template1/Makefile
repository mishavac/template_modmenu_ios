...
template_CFLAGS = -fobjc-arc
template_CCFLAGS = -std=c++11 -fno-rtti -fno-exceptions -DNDEBUG
...
template_FILES = Tweak.xm $(MENU_SRC) $(KITTYMEMORY_SRC) $(SCLALERTVIEW_SRC)

template_LIBRARIES += substrate

template_FRAMEWORKS = $(PROJ_COMMON_FRAMEWORKS)
# GO_EASY_ON_ME = 1
